...
def make_interactive_plot(G,
    ...
    c = list(categorical_vector(G, 'color'))
    typ = list(categorical_vector(G, 'cell_properties'))
    ...
    fig01.circle("x", "y", color = factor_cmap('typ', 'Category10_10', typ), alpha=0.8, source=s1)
